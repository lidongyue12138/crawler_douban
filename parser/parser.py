...
class parser_for_movie:
    def __init__(self, receiving_queue, put_to_review_queue):#之后加上put_to_movie_queue, put_to_review_queue
        ...
        while (True):
            ...
            self.saveMovie(title, year, rate, genre, tag, \
                        region, alias, director, editors, actors, time,post_href,\
                         id_num)
